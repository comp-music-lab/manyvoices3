...
folder_path <- "./Confirmatory analysis/data/pitch processed4/" #Modify the path to the location where the ***pitch processed folder*** is stored on your local computer
...
folder_path2 <- "./Confirmatory analysis/data/IOI3++/" #Modify the path to the location where the ***IOI files*** are stored on your local computer
# Get the path of all csv files
...
ggsave("./Confirmatory analysis/figures/combined_plot_acoustic features.png", plot = combined_plot, width = 12, height = 6) #Modify the path to the location where you want to save the images on your local computer

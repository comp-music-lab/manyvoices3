...
effectsize_f0 <- read_csv(file='https://raw.github.com/comp-music-lab/manyvoices3/refs/heads/main/ChibaEtAl(Japanese)/Confirmatory%20analysis/data/pitch%20processed4/f0_cohend_results.csv') %>%
  mutate(Feature = "Pitch Height")
effectsize_f0stab <- read_csv(file='https://raw.github.com/comp-music-lab/manyvoices3/refs/heads/main/ChibaEtAl(Japanese)/Confirmatory%20analysis/data/pitch%20processed4/f0stab_cohend_results.csv') %>%
  mutate(Feature = "Pitch Stability")
effectsize_IOI <- read_csv(file='https://raw.github.com/comp-music-lab/manyvoices3/refs/heads/main/ChibaEtAl(Japanese)/Confirmatory%20analysis/data/IOI3%2B%2B/IOI_cohend_results.csv') %>%
...
CI_f0 <- read_csv(file='https://raw.github.com/comp-music-lab/manyvoices3/refs/heads/main/ChibaEtAl(Japanese)/Confirmatory%20analysis/data/pitch%20processed4/f0_extra_results.csv') %>%
  mutate(Feature = "Pitch Height")
CI_f0stab <- read_csv(file='https://raw.github.com/comp-music-lab/manyvoices3/refs/heads/main/ChibaEtAl(Japanese)/Confirmatory%20analysis/data/pitch%20processed4/f0stab_extra_results.csv') %>%
  mutate(Feature = "Pitch Stability")
CI_IOI <- read_csv(file='https://raw.github.com/comp-music-lab/manyvoices3/refs/heads/main/ChibaEtAl(Japanese)/Confirmatory%20analysis/data/IOI3%2B%2B/IOI_extra_results.csv') %>%
  mutate(Feature = "IOI Rate")
...
print(g)
ggsave("./Confirmatory analysis/figures/plot_cohend.png", plot = g) #Modify the path to the location where you want to save the images on your local computer
